...
public class LightingMaps : GameWindow
{
    ...
    public LightingMaps(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
    ...
    protected override void OnLoad()
    {
        ...
        _lightingShader = new Shader("Shaders/LightingMaps/shader.vert", "Shaders/LightingMaps/lighting.frag");
        _lampShader = new Shader("Shaders/LightingMaps/shader.vert", "Shaders/LightingMaps/shader.frag");
