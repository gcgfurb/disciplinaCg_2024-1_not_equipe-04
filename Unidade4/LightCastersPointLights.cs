...
using OpenTK.Windowing.Desktop;
    ...
    public class LightCastersPointLights : GameWindow
    {
        ...
        public LightCastersPointLights(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        _lightingShader = new Shader("Shaders/LightCastersPointLights/shader.vert", "Shaders/LightCastersPointLights/lighting.frag");
        _lampShader = new Shader("Shaders/LightCastersPointLights/shader.vert", "Shaders/LightCastersPointLights/shader.frag");
