...
public class LightCastersDirectionalLights : GameWindow
{
    ...
    public LightCastersDirectionalLights(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
    ...
    protected override void OnLoad()
    {
        ...
        _lightingShader = new Shader("Shaders/LightCastersDirectionalLights/shader.vert", "Shaders/LightCastersDirectionalLights/lighting.frag");
        _lampShader = new Shader("Shaders/LightCastersDirectionalLights/shader.vert", "Shaders/LightCastersDirectionalLights/shader.frag");
        ...
        _diffuseMap = Texture.LoadFromFile("Resources/gon-and-killua.png");
        _specularMap = Texture.LoadFromFile("Resources/gon-and-killua.png");
