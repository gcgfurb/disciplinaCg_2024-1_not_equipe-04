...
public class MultipleLights : GameWindow
{
    ...
    public MultipleLights(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
    ...
    protected override void OnLoad()
    {
        ...
        _lightingShader = new Shader("Shaders/MultipleLights/shader.vert", "Shaders/MultipleLights/lighting.frag");
        _lampShader = new Shader("Shaders/MultipleLights/shader.vert", "Shaders/MultipleLights/shader.frag");
