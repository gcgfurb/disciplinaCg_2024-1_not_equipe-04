...
public class BasicLighting : GameWindow
{
    ...
    public BasicLighting(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
    ...
    protected override void OnLoad()
    {
        ...
        _lightingShader = new Shader("Shaders/BasicLighting/shader.vert", "Shaders/BasicLighting/lighting.frag");
