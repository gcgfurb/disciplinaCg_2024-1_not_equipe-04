...
public class LightCastersSpotlight : GameWindow
{
    ...
    public LightCastersSpotlight(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
    ...
    protected override void OnLoad()
    {
        ...
        _lightingShader = new Shader("Shaders/LightCastersSpotlight/shader.vert", "Shaders/LightCastersSpotlight/lighting.frag");
        _lampShader = new Shader("Shaders/LightCastersSpotlight/shader.vert", "Shaders/LightCastersSpotlight/shader.frag");
